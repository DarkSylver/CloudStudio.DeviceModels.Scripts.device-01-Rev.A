...
# Parsing + Configuration Script – device-01 - Rev. A

This **Parsing + Configuration** script is designed for the **device-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – device-01 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **device-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
